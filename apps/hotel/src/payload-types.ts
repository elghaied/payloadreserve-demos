...
export interface Amenity {
  ...
  /**
   * Icon name (e.g., pool, spa, wifi, restaurant)
   */
  icon?: string | null;
...
export interface Gallery {
  ...
  image: string | Media;
  caption?: string | null;
  category?: ('rooms' | 'lobby' | 'dining' | 'amenities' | 'exterior') | null;
  featured?: boolean | null;
  updatedAt: string;
  createdAt: string;
}
