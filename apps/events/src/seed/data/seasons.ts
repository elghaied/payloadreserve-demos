export const seasonsData = [
  {
    ...
    description: {
      ...
      fr: 'Une saison de renouveau avec de nouvelles commandes, des artistes émergents et le retour de notre série de concerts en plein air sur La Terrasse.',
    },
  ...
  },
  {
    ...
    description: {
      ...
      fr: 'Longues soirées de cinéma en plein air, jazz sous les étoiles et notre festival annuel célébrant l\'intersection de l\'art et de la technologie.',
    },
  ...
  },
  {
    ...
    description: {
      ...
      fr: 'Notre saison la plus riche : Nuit Blanche, compagnies de danse internationales, une grande rétrospective et le festival du film documentaire.',
    },
    startDate: '2026-09-23',
    endDate: '2026-12-20',
    imageKey: 'seasonAutumn' as const,
    active: false,
  },
  {
    ...
    description: {
      ...
      fr: 'Concerts de musique de chambre intimes, spectacles des fêtes et séries d\'ateliers pour réchauffer les mois les plus froids avec de la créativité.',
    },
    startDate: '2026-12-21',
    endDate: '2027-03-19',
    imageKey: 'seasonWinter' as const,
    active: false,
  },
]
