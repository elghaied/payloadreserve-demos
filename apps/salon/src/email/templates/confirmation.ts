...
const translations = {
  en: {
    ...
    minutes: 'minutes',
    reminder:
      'Please arrive 5 minutes before your scheduled appointment. If you need to cancel or reschedule, please do so at least 24 hours in advance.',
  ...
  fr: {
    ...
    intro: 'Votre rendez-vous a ete confirme. Nous avons hate de vous accueillir !',
    detailsHeading: 'Details du rendez-vous',
    service: 'Service',
    ...
    minutes: 'minutes',
    reminder:
      'Veuillez arriver 5 minutes avant votre rendez-vous. Si vous devez annuler ou reporter, merci de le faire au moins 24 heures a l\'avance.',
    closing: 'A bientot,',
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td style="padding: 0 40px 40px 40px;">
                    <p style="margin: 0 0 24px 0; font-size: 14px; line-height: 1.6; color: #888888; border-left: 2px solid #C4A35A; padding-left: 16px;">
                      ${t.reminder}
                    </p>
                    <p style="margin: 0; font-size: 16px; line-height: 1.6; color: #555555;">
                      ${t.closing}<br />
