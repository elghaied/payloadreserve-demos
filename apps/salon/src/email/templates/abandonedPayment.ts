type AbandonedPaymentEmailData = {
  customerName: string
  serviceName: string
...
const translations = {
  en: {
    ...
    intro: 'You have a reservation slot waiting for you, but your payment is not yet complete.',
    urgency: 'Your slot is reserved for a limited time. Please complete your payment before it is released.',
    ...
    ignore: 'If you no longer wish to book this appointment, you may ignore this email.',
    closing: 'See you soon,',
    team: 'The Lumiere Salon Team',
  },
  fr: {
    subject: 'Completez votre reservation',
    greeting: (name: string) => `Cher(e) ${name},`,
    intro: 'Vous avez un creneau de reservation en attente, mais votre paiement n\'est pas encore termine.',
    urgency: 'Votre creneau est reserve pour une duree limitee. Veuillez finaliser votre paiement avant qu\'il ne soit libere.',
    ...
    ignore: 'Si vous ne souhaitez plus reserver ce rendez-vous, vous pouvez ignorer cet e-mail.',
    closing: 'A bientot,',
    team: 'L\'equipe Lumiere Salon',
  },
}

export function abandonedPaymentEmail(data: AbandonedPaymentEmailData): {
  subject: string
  html: string
} {
  const {
  ...
  const bookingUrl = `${siteUrl}/${locale}/book`
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="padding: 40px 40px 24px 40px;">
                    ...
                    <p style="margin: 0 0 12px 0; font-size: 16px; line-height: 1.6; color: #555555;">
                      ${t.intro}
                    </p>
                    <p style="margin: 0; font-size: 14px; line-height: 1.6; color: #C4A35A; font-style: italic;">
                      ${t.urgency}
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding: 0 40px 40px 40px;">
                    <table role="presentation" cellpadding="0" cellspacing="0" style="margin-bottom: 24px;">
                      <tr>
                        <td style="background-color: #C4A35A; border-radius: 2px;">
                          <a href="${bookingUrl}" style="display: inline-block; padding: 14px 32px; font-size: 15px; font-weight: 600; color: #FFFFFF; text-decoration: none; letter-spacing: 1px; text-transform: uppercase;">${t.cta}</a>
                        </td>
                      </tr>
                    </table>
                    <p style="margin: 0 0 24px 0; font-size: 13px; line-height: 1.6; color: #BBBBBB;">
                      ${t.ignore}
                    </p>
