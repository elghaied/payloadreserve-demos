      ...
      <main className="min-h-screen bg-[#FAFAF8] pt-16 px-6 py-20">
        <div className="max-w-lg mx-auto">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm shadow-gray-100/50 p-8">
            {/* Header */}
            <div className="mb-7">
              <h1 className="font-display text-[2.2rem] text-[#1C1917] leading-tight mb-3">{t('headline')}</h1>
              <p className="text-[#78716C] text-sm leading-relaxed">{t('description', { hours: ttlHours })}</p>
            </div>
