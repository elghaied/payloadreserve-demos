...
export function ErrorScreen({
  ...
  const isRateLimit = message.toLowerCase().includes('24 hours') || message.toLowerCase().includes('already have')
    ...
    <div className="space-y-6 text-center py-4">
      ...
      <div>
        <p className="text-white font-medium text-sm mb-1.5">
          {isRateLimit ? 'Demo limit reached' : isCapacity ? 'At capacity' : 'Request failed'}
        </p>
