      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        >
          ...
          <div className="space-y-1.5">
            <div className="px-3 py-2 rounded-lg text-[11px] font-semibold text-center bg-gray-50 dark:bg-stone-700 text-gray-500 dark:text-stone-400 border border-gray-100 dark:border-stone-600">
              10:00 AM
            </div>
            <div className="px-3 py-2 rounded-lg text-[11px] font-semibold text-center bg-violet-600 text-white shadow-sm shadow-violet-400/30">
              11:30 AM ✓
            </div>
            <div className="px-3 py-2 rounded-lg text-[11px] font-semibold text-center bg-gray-50 dark:bg-stone-700 text-gray-500 dark:text-stone-400 border border-gray-100 dark:border-stone-600">
              2:00 PM
        ...
        >
          ...
          <div className="grid grid-cols-3 gap-1.5 mb-3">
            <div className="py-1.5 rounded-lg text-[10px] font-semibold text-center bg-gray-50 dark:bg-stone-700 text-gray-500 dark:text-stone-400 border border-gray-100 dark:border-stone-600">
              7:00
            </div>
            <div className="py-1.5 rounded-lg text-[10px] font-semibold text-center bg-gray-50 dark:bg-stone-700 text-gray-500 dark:text-stone-400 border border-gray-100 dark:border-stone-600">
              7:30
            </div>
            <div className="py-1.5 rounded-lg text-[10px] font-semibold text-center bg-amber-500 text-black shadow-sm">
              8:00 ✓
            </div>
            <div className="py-1.5 rounded-lg text-[10px] font-semibold text-center bg-gray-50 dark:bg-stone-700 text-gray-500 dark:text-stone-400 border border-gray-100 dark:border-stone-600">
              8:30
        ...
        >
          ...
          <div className="space-y-1.5 mb-3">
            <div className="flex items-center justify-between px-2.5 py-2 rounded-lg bg-gray-50 dark:bg-stone-700 border border-gray-100 dark:border-stone-600">
              <span className="text-[10px] font-semibold text-[#1C1917] dark:text-stone-100">
                Feb 3
              </span>
              <span className="text-[9px] font-bold px-2 py-0.5 rounded-full bg-emerald-100 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-400">
                Available
              </span>
            </div>
            <div className="flex items-center justify-between px-2.5 py-2 rounded-lg bg-gray-50 dark:bg-stone-700 border border-gray-100 dark:border-stone-600">
              ...
              <span className="text-[9px] font-bold px-2 py-0.5 rounded-full bg-red-100 dark:bg-red-900/40 text-red-600 dark:text-red-400">
                Booked
              </span>
            </div>
