      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-6">
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 text-sm text-[#78716C] hover:text-[#1C1917] dark:text-stone-400 dark:hover:text-stone-100 transition-colors font-medium"
          >
          ...
          <Link
            href="/demo"
            className="inline-flex items-center gap-1.5 bg-amber-500 hover:bg-amber-400 active:scale-95 text-black font-semibold text-sm px-4 py-2 rounded-full transition-all duration-150 shadow-sm shadow-amber-500/20"
          >
            Try Demo
          </Link>
        </nav>
