...
export function DeveloperSection({ homepage, githubUrl }: Props) {
  const steps = homepage.devSteps ?? []
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="font-display text-[clamp(2rem,4vw,3.2rem)] text-stone-50 leading-[1.1] mb-5">
            {homepage.devHeadline}
          </h2>
          <p className="text-stone-400 text-lg leading-relaxed">
            {homepage.devSubtitle}
          </p>
        </div>
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-stone-500 text-sm">{homepage.devNote}</p>
        </div>
      </div>
    </section>
  )
